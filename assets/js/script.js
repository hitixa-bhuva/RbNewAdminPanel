...
-----------------------------------------------------------------------------------
 ...
 document.addEventListener('DOMContentLoaded', function () {
  // Common function to open the date picker
  function openDatePicker(event) {
      const dateInput = event.target; // Get the clicked input
      dateInput.showPicker(); // Opens the native datepicker
  }

  // Function to initialize date inputs
  function initializeDatePickers() {
      // Select all date inputs with the class 'date-input'
      const dateInputs = document.querySelectorAll('.date-input');

      dateInputs.forEach(input => {
          input.onclick = openDatePicker; // Assign the openDatePicker function
      });
  }
